...
export default function ElectricalService({ navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Hi, I'm a Professional Electrician ⚡</Text>

      <Image
        source={residentialElectrician}
        style={styles.image}
      />
      <Text style={styles.text}>
        I specialize in safe, efficient electrical work for homes, businesses, and solar systems.
      </Text>
      ...
      />
      <Text style={styles.text}>
        I also work with modern solar power systems and smart energy solutions.
      </Text>
