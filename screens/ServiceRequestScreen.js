                        ...
                        <View style={styles.inputRow}>
                            <View style={[styles.inputGroup, styles.halfWidth]}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(value) =>
                                        updateFormData('preferredDate', value)
                                    }
                                />
                            </View>
...
const styles = StyleSheet.create({
    ...
    header: { padding: 30, alignItems: 'center', backgroundColor: '#f8f9fa' },
    headerTitle: {
        fontSize: 24,
        fontWeight: 'bold',
        color: '#001f3f',
    ...
    urgencySelected: { backgroundColor: '#f0f9ff' },
    urgencyDot: { width: 12, height: 12, borderRadius: 6, marginRight: 10 },
    urgencyText: { fontSize: 14, color: '#666', flex: 1 },
    urgencyTextSelected: { color: '#001f3f', fontWeight: '500' },
    ...
    guaranteeText: { fontSize: 14, color: '#666', flex: 1, lineHeight: 20 },
    submitButton: {
